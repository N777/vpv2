...
#define LEN_ADDR0 22 // размер адреса таблицы дл€ полинома нулевой степени
#define LEN_ADDR1 12  // размер адреса таблицы дл€ полинома первой степени
#define LEN_ADDR2 12  // размер адреса таблицы дл€ полинома второй степени
